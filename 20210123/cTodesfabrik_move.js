class Todesfabrik {
  ...
  distort(x,y,w,h,cw=0.2,ch=0.6) {
    ...
    beginShape()
    this.draw_body(x, y, w, h, cw, ch);
    endShape(CLOSE);
  }

  draw_body(x, y, w, h, cw=0.2, ch=0.6) {
    this.draw_body1(x, y, w, h, cw, ch);
    this.draw_roof(x, y, w, h, ch);
    this.draw_body2(x, y, w, h, cw, ch);
    this.draw_contours(x, y, w, h, cw, ch);
  }
